...
1. Admin page Settings tab screenshot
...
* Tested and compatible with WordPress 6.5.3

= 2.0 =
* Added security patches
* Tested and compatible with WordPress 6.5.2
...
= 1.7 =
* Tested and compatible with WordPress 5.5

= 1.6 =
* Tested and compatible with WordPress 5.2.3

= 1.5 =
* Tested and compatible with WordPress 4.9.5

= 1.4 =
* Fixed designing

= 1.3 =
* Fixed designing issue in help section
* added horizontal rular in settings tab for better indication

= 1.2 =
* Better page loading and added help section

= 1.1 =
* Tested and compatible with WordPress 4.3
